...
def generate_transactions():
    ...
    # to exercise the optional ISO 20022 metadata under `properties`
    # (transactionCode, remittanceInformation, endToEndId) alongside
    # the typed counterparty.
    transactions.append({
        "id": "tx_001",
        ...
        "properties": {
            "transactionCode": "PMNT-RCDT-SALA",
            "remittanceInformation": "Payroll, March 2024",
    ...
    # fields (transactionDate distinct from `date`,
    # counterparty.postalAddress with townName / country / postCode,
    # and card audit metadata under `properties` — maskedPan,
    # merchantCategoryCode, proprietaryBankTransactionCode) added in
    # spec 0.12 to align with Open Finance `cardTransactions`.
    transactions.extend([
        {
        ...
        },
        {
            ...
            "originalDescription": "SELFRIDGES&CO  400 OXFORD ST  LONDON  GB",
            "amount": -210.45,
    ...
    # under `properties` so the `full` verbosity path has a row that
    # lights them up.
    transactions.append({
        ...
        "properties": {
            "transactionCode": "PMNT-RDDT-ESDD",
