...
- Your server registers the tools defined by the [spec](/docs/specification/overview). Run the [drift test](/docs/library/testing#1-spec-drift-test), it should pass.
