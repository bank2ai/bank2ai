...
| [`transactions`](/docs/specification/tools/transactions) | `count: int \| None`, `type: Literal["Any","Income","Expenses","Savings"]`, `order: Literal["NewestFirst","OldestFirst"]`, `start_date: str \| None`, `end_date: str \| None`, `description: str \| None`, `categories: list[str] \| None`, `account_id: str \| None` |
