...
Tools whose handler is omitted are simply not registered. Add `get_transactions`, `get_transactions_summary`, `search_recipients`, `create_recipient`, `prepare_transfer`, and `execute_transfer` as you implement them.
