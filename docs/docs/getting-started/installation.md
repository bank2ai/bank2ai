...
| `bank2ai.mcp` | Reusable MCP tool surface — `register_tools` wires the eight Bank2AI tools onto a [FastMCP](https://github.com/jlowin/fastmcp) app and dispatches each call to handlers you provide. |
